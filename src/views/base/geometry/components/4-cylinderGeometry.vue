<template>
  <el-card class="mr-14px mb-14px">
    <template #header> 4.圆柱缓冲几何体-CylinderGeometry </template>
    <div id="base-cylinderGeometry"></div>
  </el-card>
</template>
...
defineOptions({
  name: 'base-cylinderGeometry',
  inheritAttrs: false,
});

const width = 400;
const height = 400;
const { threeState, THREE } = useThree('base-cylinderGeometry', {
  config: {
    width,
    height,
...
function initGeometry() {
   ...
   */
  const geometry = new THREE.CylinderGeometry(30, 30, 100);
