<template>
  <el-card class="mr-14px mb-14px">
    <template #header> 2.圆形缓冲几何体-CircleGeometry </template>
    <div id="base-circleGeometry"></div>
  </el-card>
</template>
...
defineOptions({
  name: 'base-circleGeometry',
  inheritAttrs: false,
});

const width = 400;
const height = 400;
const { threeState, THREE } = useThree('base-circleGeometry', {
  config: {
    width,
    height,
